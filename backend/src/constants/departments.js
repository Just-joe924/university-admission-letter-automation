// Departments and the courses offered under each, used to validate bulk-imported
// students on the server.
//
// Keep this in sync with frontend/src/constants/departments.js (the Add Student
// form's dropdowns). The frontend and backend deploy separately, so they can't
// share one file; test/departments.test.js fails if the two lists drift apart.
